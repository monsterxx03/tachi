...
var Registry = []Def{
	...
	{Name: "sh", Description: "Run a shell command in the session working directory and echo its output (no LLM)", InputHint: "<command>", Modes: []Mode{ModeTUI, ModeChannel, ModeDesktop}},
